...
- CRITICAL: This image will be cropped to multiple aspect ratios (1:1, 4:5, 9:16, 16:9) — design must work in all of them
- CRITICAL: Place ALL text and key visual elements in the CENTER 60% width and 70% height of the image only
- CRITICAL: The outer 20% on each side and 15% top and bottom must be empty background only — no text, no faces, no key elements near edges
