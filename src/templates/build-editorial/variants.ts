  ...
  const be1x1: Template = {
    ...
    elements: [
      ...
      { id: 'title', type: 'text', x: 60, y: 460, width: 960, height: 300,
        props: { text: 'CONSTRUCAO DO ZERO', fontSize: 100, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: DARK, wrap: 'word', autoFit: true } },
  ...
  const be9x16: Template = {
    ...
    elements: [
      ...
      { id: 'title', type: 'text', x: 60, y: 880, width: 960, height: 400,
        props: { text: 'CONSTRUCAO DO ZERO', fontSize: 120, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: DARK, wrap: 'word', autoFit: true } },
