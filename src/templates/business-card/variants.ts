  ...
  const bc1x1: Template = {
    ...
    elements: [
      ...
      { id: 'title', type: 'text', x: 60, y: 460, width: 960, height: 280,
        props: { text: 'Nome do\nServiço', fontSize: 180, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: WHITE, wrap: 'word', autoFit: true } }, fontSize: 140, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: WHITE, wrap: 'word', autoFit: true } },
  ...
  const bc9x16: Template = {
    ...
    elements: [
      ...
      { id: 'title', type: 'text', x: 60, y: 880, width: 960, height: 380,
        props: { text: 'Nome do\nServiço', fontSize: 180, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: WHITE, wrap: 'word', autoFit: true } }, fontSize: 180, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: WHITE, wrap: 'word', autoFit: true } },
