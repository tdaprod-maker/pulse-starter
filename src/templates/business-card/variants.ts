  ...
  const bc1x1: Template = {
    ...
    elements: [
      ...
      { id: 'title', type: 'text', x: 60, y: 460, width: 960, height: 280,
        props: { text: 'Nome do\nServico', fontSize: 140, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: WHITE, wrap: 'word', autoFit: true } },
      { id: 'body', type: 'text', x: 60, y: 780, width: 840, height: 120,
        props: { text: 'Descreva brevemente o seu servico ou produto em uma ou duas linhas de forma clara e direta.', fontSize: 26, fontFamily: BODY, fontStyle: 'normal', lineHeight: 1.5, align: 'left', fill: MUTED, wrap: 'word' } },
  ...
  const bc9x16: Template = {
    ...
    elements: [
      ...
      { id: 'title', type: 'text', x: 60, y: 880, width: 960, height: 380,
        props: { text: 'Nome do\nServico', fontSize: 180, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1.0, align: 'left', fill: WHITE, wrap: 'word', autoFit: true } },
      { id: 'body', type: 'text', x: 60, y: 1340, width: 840, height: 160,
        props: { text: 'Descreva brevemente o seu servico ou produto em uma ou duas linhas de forma clara e direta.', fontSize: 32, fontFamily: BODY, fontStyle: 'normal', lineHeight: 1.5, align: 'left', fill: MUTED, wrap: 'word' } },
  ...
  const bc16x9: Template = {
    ...
    elements: [
      ...
      { id: 'body', type: 'text', x: 1060, y: 460, width: 760, height: 200,
        props: { text: 'Descreva brevemente o seu servico ou produto de forma clara e direta.', fontSize: 28, fontFamily: BODY, fontStyle: 'normal', lineHeight: 1.5, align: 'left', fill: MUTED, wrap: 'word' } },
