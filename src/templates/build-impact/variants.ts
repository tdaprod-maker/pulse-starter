...
export function makeBuildImpactVariants(theme: Theme): Template[] {
  ...
  const bi1x1: Template = {
    ...
    elements: [
      ...
      { id: 'number', type: 'text', x: 60, y: 540, width: 960, height: 280,
        props: { text: '+000m2', fontSize: 240, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1, align: 'left', fill: WHITE, wrap: 'none', autoFit: true } },
      { id: 'symbol', type: 'text', x: 700, y: 600, width: 320, height: 160,
        props: { text: 'm2', fontSize: 120, fontFamily: HEADING, fontStyle: 'normal', lineHeight: 1, align: 'left', fill: PRIMARY, wrap: 'none' } },
  ...
  const bi4x5: Template = {
    ...
    elements: [
      ...
      { id: 'number', type: 'text', x: 60, y: 720, width: 960, height: 280,
        props: { text: '+000m2', fontSize: 240, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1, align: 'left', fill: WHITE, wrap: 'none', autoFit: true } },
      { id: 'symbol', type: 'text', x: 700, y: 780, width: 320, height: 160,
        props: { text: 'm2', fontSize: 120, fontFamily: HEADING, fontStyle: 'normal', lineHeight: 1, align: 'left', fill: PRIMARY, wrap: 'none' } },
  ...
  const bi9x16: Template = {
    ...
    elements: [
      ...
      { id: 'number', type: 'text', x: 60, y: 1000, width: 960, height: 360,
        props: { text: '+000m2', fontSize: 300, fontFamily: HEADING, fontStyle: 'bold', lineHeight: 1, align: 'left', fill: WHITE, wrap: 'none', autoFit: true } },
      { id: 'symbol', type: 'text', x: 700, y: 1080, width: 320, height: 200,
        props: { text: 'm2', fontSize: 160, fontFamily: HEADING, fontStyle: 'normal', lineHeight: 1, align: 'left', fill: PRIMARY, wrap: 'none' } },
  ...
  const bi16x9: Template = {
    ...
    elements: [
      ...
      { id: 'symbol', type: 'text', x: 1060, y: 340, width: 400, height: 200,
        props: { text: 'm2', fontSize: 160, fontFamily: HEADING, fontStyle: 'normal', lineHeight: 1, align: 'left', fill: PRIMARY, wrap: 'none' } },
