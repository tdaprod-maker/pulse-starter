...
const GROUPS = [
  ...
  { label: 'Outros', ids: ['food-vertical', 'bold-circle', 'editorial-cover', 'split-editorial', 'geo-impact', 'tech-statement', 'tech-news', 'tech-product', 'tech-minimal', 'product-arch', 'hero-gradient', 'job-glass', 'editorial-card'] },
]
