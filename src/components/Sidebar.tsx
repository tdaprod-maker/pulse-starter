...
const GROUPS = [
  ...
  { label: 'Outros', ids: ['editorial-cover', 'split-editorial', 'geo-impact', 'tech-statement', 'tech-news', 'tech-product', 'tech-minimal', 'hero-title', 'big-statement', 'editorial-card', 'big-number'] },
]
