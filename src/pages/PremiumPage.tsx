      ...
      if (mode === 'single') {
        ...
        for (let i = 1; i <= slideCount; i++) {
          ...
          const slidePromptText = i === 1
            ...
            : i === slideCount
            ? `CAROUSEL CLOSING SLIDE ${slideCount} of ${slideCount}. MANDATORY TEXT TO DISPLAY: "${slideContent}". The text shown in the image MUST be based strictly on this — do not invent or replace it. Design: strong CTA slide — clearly visible action phrase, one bold closing statement maximum 5 words. Dark background, brand accent color on CTA element, cinematic mood. NO robotic hands, NO AI cubes, NO generic tech imagery. Vertical 4:5 format. All text within center 55% width and 60% height. No borders or frames.`
