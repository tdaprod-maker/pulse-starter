...
- "game-day"       → posts esportivos com evento, resultado ou convocação. Ideal para times, academias e competições
  Campos: tag (categoria em maiúsculas, ex: "CAMPEONATO PAULISTA", "TREINO DO DIA"), title (título em maiúsculas, 2-4 palavras com \n para quebrar, ex: "É FINAL,\nINDAIÁ!"), subtitle (detalhe do evento, ex: "Sub-11 · Sábado 15h · Arena Central")
