...
export interface AgentResponse {
  ...
  /** true quando "slides" foi preenchido por fallback server-side (agent-chat.js), não pelo usuário — não deve sobrescrever o conteúdo gerado por generate-carousel.js. */
  slidesAutoGenerated?: boolean
  // Edit mode fields
  actions?: EditAction[]
